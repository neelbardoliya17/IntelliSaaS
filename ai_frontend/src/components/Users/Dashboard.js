        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              <p className="mb-4">Next Billing Date: {data?.user?.nextBilingDate ? data?.user?.nextBilingDate : 'No Biling Date'}</p>
            </div>
          </div>
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              ...
              {data?.user?.subscriptionPlan==='Trial' && <p className="border mb-2 rounded w-full py-2 px-3 text-gray-700 leading-tight">Trail:1000 monthly request</p>}
              ...
              {data?.user?.subscriptionPlan==='Premium' && <p className="border mb-2 rounded w-full py-2 px-3 text-gray-700 leading-tight">Premium: 100 monthly request</p>}
          ...
          <div className="mb-6 bg-white p-4 shadow rounded-lg">
            ...
            <div>
              <p className="mb-4">Trial Status: {data?.user?.trialActive ? <span className="text-green-500">Active</span> : <span className="text-red-600">Inactive</span>}</p>
